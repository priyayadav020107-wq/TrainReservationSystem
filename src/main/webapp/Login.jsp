...
<head>
    ...
    <style>
        ...
        */
        ...
        /* Highlighted active field to mirror reference's orange-outlined "FROM" box */
        ...
        .link .sep { color: #4a4a50; margin: 0 8px; }
        ...
        <div class="split-container">
            ...
            <div class="left-panel">
                <div class="left-caption">
                    ...
                    <h1>Book your<br>journey with ease</h1>
                </div>
            </div>
            ...
            <div class="right-panel">
              <div class="right-panel-inner">
                ...
                <h2 class="form-title">User<span class="dot-accent">.</span></h2>
                <div class="form-subtitle">Login to manage your bookings</div>

                <% if(request.getAttribute("error") != null) { %>
                    <div class="error"><%= request.getAttribute("error") %></div>
                <% } %>
                <% if(request.getAttribute("message") != null) { %>
                    <div class="error success-msg"><%= request.getAttribute("message") %></div>
                <% } %>
